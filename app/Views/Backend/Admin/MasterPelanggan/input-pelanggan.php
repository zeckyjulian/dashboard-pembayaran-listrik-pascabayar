<div class="page-inner">
    ...
    <div class="row">
        <div class="col-md-12">
        <div class="card">
            <form action="<?php echo base_url('admin/simpan-pelanggan') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    id="nokwh"
                    name="nokwh"
                    placeholder="Contoh: 12345678900"
                    required
                    />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 1234567890/,.',this)" id="alamat" name="alamat" rows="6" required>
                    </input>
                </div>
                </div>
            </div>
